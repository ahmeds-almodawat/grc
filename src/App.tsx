...
import { RealDataImportRunner } from './pages/RealDataImportRunner';
  ...
  return (
    <TabbedHub
      ...
      tabs={[
        ...
        { id: 'realDataImportRunner', label: t('hub.tab.realDataImportRunner', 'Real Data Import Runner'), description: t('hub.tab.realDataImportRunner.desc', 'Staging-first dry-run and apply orchestration for the reviewed GRC import-ready pack.'), icon: <UploadCloud size={17} />, content: <RealDataImportRunner /> },
