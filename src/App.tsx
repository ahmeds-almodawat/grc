...
function RealDataControlPages() {
  ...
  return (
    <TabbedHub
      ...
      tabs={[
        { id: 'realDataImportCenter', label: t('hub.tab.realDataImportCenter', 'System Import Center'), description: t('hub.tab.realDataImportCenter.desc', 'Control center for the reviewed GRC import-ready pack, reports, snapshots, and readiness.'), icon: <UploadCloud size={17} />, content: <RealDataImportCenter /> },
