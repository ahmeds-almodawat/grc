...
const liveEmptyScorecard: V35Scorecard = emptyLiveObject<V35Scorecard>('liveEmptyScorecard');

const liveEmptyOperator: V35OperatorConsole = emptyLiveObject<V35OperatorConsole>('liveEmptyOperator');

const liveEmptyBlockers: V35Blocker[] = emptyLiveArray<V35Blocker>();
