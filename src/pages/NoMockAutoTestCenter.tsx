...
const phases = [
  ...
  { n: 2, en: 'No-mock audit', ar: 'تدقيق البيانات التجريبية', cmd: 'npm run test:phase2', score: 88, noteEn: 'Find mock/demo/emptyRows/sample data before pilot.', noteAr: 'اكتشاف البيانات التجريبية أو الاحتياطية قبل التجربة.' },
...
const rules = [
  { en: 'No silent emptyRows data in production screens.', ar: 'لا توجد بيانات احتياطية صامتة في شاشات الإنتاج.' },
        ...
        <div>
          ...
          <p className="muted-text">
            {ar
              ...
              : 'This layer blocks silent mock/demo emptyRows behavior and turns validation into clear phases before pilot and production.'}
          </p>
        </div>
