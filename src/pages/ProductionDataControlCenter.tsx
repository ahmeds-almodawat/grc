  ...
  const cards = [
    {
      ...
      body: isArabic ? 'تشغيل v60:remediate يمنع استخدام البيانات البديلة بشكل صامت في الإنتاج.' : 'Run v60:remediate to stop silent runtime emptyRows/demo data in production.'
    },
    {
    ...
    <main className="page-shell">
      <section className="page-hero compact">
        <div>
          ...
          <p>{isArabic ? 'منع ظهور بيانات تجريبية أو بديلة بشكل صامت في بيئة الإنتاج.' : 'Prevent silent mock, demo, sample, or emptyRows data from appearing in production.'}</p>
        </div>
      </section>
