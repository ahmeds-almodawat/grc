  ...
  return (
    <section className="page-section grc-dashboard grc-dashboard--home">
      ...
      <header className="grc-dashboard-intro">
        <ModuleHeader eyebrow={t('dashboard.v11.eyebrow', 'Executive overview')} title={t('dashboard.v11.title', 'Governance performance and strategic delivery')} subtitle={t('dashboard.v11.subtitle', 'Governed OVR analytics and role-scoped operational intelligence.')} />
      ...
      <div className="grc-metric-strip" aria-label={t('dashboard.v11.kpis', 'Executive KPIs')}>
        <DashboardMetricCard icon="ovr" label={t('dashboard.v11.openOvr', 'Open OVR')} value={metricBandLabel(ovrHeadline?.metrics.open_ovr, '—', ovrHeadline?.privacy.minimum_cell_size)} state={aggregateState} privacyLabel={t('dashboard.v11.privacySafe', 'Privacy protected')} onClick={() => navigate('ovr')} />
      ...
      <div className="grc-dashboard-command-grid">
        <DashboardSection className="grc-dashboard-trend-panel" title={t('dashboard.v11.performanceTrend', 'GRC performance trend')} hint={t('dashboard.v11.trendHint', '12-month organization summary; dashboard filters do not apply.')}>
      ...
      <div className="grc-dashboard-grid">
        ...
        <div className="span-4"><DashboardSection title={t('dashboard.v11.incidentSeverity', 'Incident severity')} hint={t('dashboard.v11.ovrFilterScope', 'Organization-wide summary; dashboard filters do not apply.')}>
