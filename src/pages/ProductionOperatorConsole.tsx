      ...
      <div className="page-header">
        ...
        {setPage ? (
          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
            <button className="secondary-action" type="button" aria-label="Route evidence closure, reviewer readiness, ownership and due date readiness, executive recommendation readiness, department evidence coverage readiness, policy/SOP attestation evidence readiness, backup, restore, and DR evidence readiness, and access review and security evidence readiness in Production Evidence Closure" onClick={() => setPage('productionEvidenceClosure')}>
              <FileCheck2 size={16} />
              Production Evidence Closure security readiness
            </button>
