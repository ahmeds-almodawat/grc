...
export function AccessControl() {
  ...
  return (
    <section className="page-section">
      ...
      <div className="notice-banner">
        New accounts are created only from the protected User Excel provisioning queue. Initial credentials and forced password rotation are controlled by Patch 83U.
      </div>
