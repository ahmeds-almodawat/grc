      ...
      >
        <div className="insight-list">
          ...
          <div>
            ...
            <p>{isLiveMode() ? (language === 'ar' ? 'متصل بـ Supabase.' : 'Connected to Supabase.') : (language === 'ar' ? 'بيانات تجريبية لأن Supabase غير مفعّل.' : 'Demo fallback because Supabase is not configured.')}</p>
          </div>
        </div>
      </ModernCard>
    </ModernShell>
