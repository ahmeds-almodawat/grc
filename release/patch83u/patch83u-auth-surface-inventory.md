...
- Reviewed restricted migration 176–197 SECURITY DEFINER routines: 94
...
| `public.cancel_training_assignment_with_reason(p_assignment_id uuid, p_reason text, p_actor_id uuid)` | migration208_service_role_acl_review | yes | service_role_only | `supabase/migrations/208_e2b2_training_authorization_and_compliance_contract_remediation.sql:755` |
...
| `public.complete_training_assignment(p_assignment_id uuid, p_evidence_id uuid, p_actor_id uuid)` | migration208_service_role_acl_review | yes | service_role_only | `supabase/migrations/208_e2b2_training_authorization_and_compliance_contract_remediation.sql:393` |
...
| `public.reopen_training_assignment_with_reason(p_assignment_id uuid, p_reason text, p_actor_id uuid)` | migration208_service_role_acl_review | yes | service_role_only | `supabase/migrations/208_e2b2_training_authorization_and_compliance_contract_remediation.sql:868` |
...
| `public.start_training_assignment(p_assignment_id uuid, p_actor_id uuid)` | migration208_service_role_acl_review | yes | service_role_only | `supabase/migrations/208_e2b2_training_authorization_and_compliance_contract_remediation.sql:311` |
...
| `public.waive_training_assignment_with_reason(p_assignment_id uuid, p_reason text, p_actor_id uuid)` | migration208_service_role_acl_review | yes | service_role_only | `supabase/migrations/208_e2b2_training_authorization_and_compliance_contract_remediation.sql:642` |
