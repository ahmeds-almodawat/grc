...
const report = `# v23.0 Compliance, Policy, Vendor + Incident Hardening Report
...
fs.writeFileSync(path.join(outDir, 'v230-compliance-hardening-report.md'), report);
console.log('v23.0 compliance hardening report written.');
