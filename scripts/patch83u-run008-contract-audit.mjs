...
export const RUN008_PROOF_CONTRACT_PATH =
  'release/patch83u/patch83u-run008-proof-contract.json';
export const RUN008_TRACEABILITY_PATH =
  'release/patch83u/patch83u-run008-proof-traceability.json';
export const RUN008_TRACEABILITY_MARKDOWN_PATH =
  'release/patch83u/patch83u-run008-proof-traceability.md';
export const RUN008_CHECKPOINT_SCHEMA_PATH =
  'release/patch83u/patch83u-staging-checkpoint-file-schema-v3.json';
export const RUN008_EVIDENCE_SCHEMA_PATH =
  'release/patch83u/patch83u-staging-reset-harness-schema-v7.json';
export const RUN008_HARNESS_PATH =
  'scripts/patch83u-staging-multisession-reset-proof.mjs';
export const RUN008_SQL_CHECKPOINT_PATH =
  'scripts/patch83u-staging-sql-editor-evidence.sql';
export const RUN008_PROOF_CONTRACT_VERSION = 'patch83u-run008-proof-contract-v1';
export const RUN008_PROOF_CONTRACT_ID = 'patch83u-hosted-reset-proof-run-008';
export const RUN008_TRACEABILITY_VERSION = 'patch83u-run008-proof-traceability-v1';
export const RUN008_CONFIRMATION_CONTRACT_ID =
  'patch83u-run008-reset-confirmation-v1';
export const RUN008_CONFIRMATION_PHRASE = 'EXECUTE RUN 008 RESET NOW';
export const RUN008_EXPECTED_SESSION_COUNT = 1;
export const RUN008_EXPECTED_UNREVOKED_REFRESH_TOKEN_COUNT = 1;
export const RUN008_INITIAL_CREDENTIAL_VERSION = 4;
export const RUN008_POST_RESET_CREDENTIAL_VERSION = 5;
export const RUN008_FINAL_CREDENTIAL_VERSION = 6;
...
export const RUN008_REQUIRED_REQUIREMENT_IDS = Object.freeze([
  'R008_P01_STAGING_AND_PRODUCTION_BOUNDARY',
  'R008_P01_FRONTEND_ORIGIN_EXACT',
  'R008_P01_FREEZE_AND_EDGE_PROVENANCE_EXACT',
  'R008_P01_RUNTIME_AND_CONTRACTS_EXACT',
  'R008_P01_PROOF_ARTIFACT_HASHES_EXACT',
  'R008_P01_TRACEABILITY_COMPLETE',
  'R008_P01_CONFIRMATION_AND_COUNT_CONTRACTS_FROZEN',
  'R008_P01_EVIDENCE_EXCLUSIONS_ACTIVE',
  'R008_P02_CHECKPOINT1_READ_ONLY',
  'R008_P02_INITIAL_EMPLOYEE_STATE',
  'R008_P02_INITIAL_ADMIN_STATE',
  'R008_P02_FINALIZER_AND_RECOVERY_READY',
  'R008_P03_ADMIN_CONTEXTS_READY',
  'R008_P03_TWO_EMPLOYEE_SESSIONS',
  'R008_P03_BOTH_REFRESHES_SUCCEED',
  'R008_P03_EMPLOYEE_AUTHORIZATION_PROVEN',
  'R008_P04_CHECKPOINT2_READ_ONLY',
  'R008_P04_TARGET_PRE_RESET_UNCHANGED',
  'R008_P04_ADMIN_AND_RUNTIME_UNCHANGED',
  'R008_P05_EXACT_RESET_CONFIRMATIONS',
  'R008_P05_ONE_SHOT_RESET',
  'R008_P05_STABLE_REQUEST_CORRELATION',
  'R008_P05_AMBIGUOUS_RESET_NO_RETRY',
  'R008_P06_CHECKPOINT3_ALWAYS',
  'R008_P06_RESET_OUTCOME_CLASSIFIED',
  'R008_P06_PROTECTED_STATE_FAIL_CLOSED',
  'R008_P07_RESET_SUCCESS_STATE_V5',
  'R008_P07_RESET_ZERO_SESSIONS',
  'R008_P07_RESET_GOVERNANCE_AND_AUDIT',
  'R008_P08_OLD_PASSWORD_REJECTED',
  'R008_P08_BOTH_REFRESH_REPLAYS_REJECTED',
  'R008_P08_BOTH_STALE_CONTEXTS_DENIED',
  'R008_P09_TEMPORARY_LOGIN_SUCCEEDS',
  'R008_P09_FORCED_CHANGE_ONLY',
  'R008_P10_CHECKPOINT4_READ_ONLY',
  'R008_P10_PRE_CHANGE_STATE_V5_WITH_TEMP_SESSION',
  'R008_P11_REQUIRED_CHANGE_ACTION_EXACT',
  'R008_P11_SECRET_AND_POLICY_CONTROLS',
  'R008_P11_GLOBAL_SIGNOUT_AND_FINALIZER',
  'R008_P11_NO_AUTO_RECOVERY_ACTION',
  'R008_P12_CHECKPOINT5_READ_ONLY',
  'R008_P12_FINAL_ACTIVE_V6_ZERO',
  'R008_P12_PASSWORD_CHANGED_AT_SET',
  'R008_P12_SESSIONS_REVOKED_AT_SET',
  'R008_P12_GOVERNANCE_AND_RECONCILIATION_CLEARED',
  'R008_P12_PASSWORD_CHANGE_AUDIT_CORRELATED',
  'R008_P12_BROWSER_SIGNED_OUT',
  'R008_P13_FRESH_PERMANENT_LOGIN',
  'R008_P13_EMPLOYEE_ROLE_SCOPE_PRESERVED',
  'R008_P13_DIRECT_ADMIN_DENIED',
  'R008_P13_NETWORK_CONSOLE_SAFE',
  'R008_P14_CHECKPOINT6_READ_ONLY',
  'R008_P14_EXACT_FINAL_SESSION_COUNT',
  'R008_P14_EXACT_FINAL_REFRESH_COUNT',
  'R008_P14_ADMIN_AND_RUNTIME_UNCHANGED',
  'R008_P14_REDACTED_EVIDENCE_VALID',
]);
...
export function validateRun008ProofContract(contract) {
  exactKeys(contract, [
    'schema_version',
    'contract_id',
    'run_number',
    ...
    'evidence_contract',
    'phases',
  ], 'PATCH83U_RUN008_PROOF_CONTRACT_SHAPE_INVALID');
  if (
    contract.schema_version !== RUN008_PROOF_CONTRACT_VERSION
    || contract.contract_id !== RUN008_PROOF_CONTRACT_ID
    || contract.run_number !== 8
    || contract.decision_is_execution_authorization !== false
  ) {
    fail('PATCH83U_RUN008_PROOF_CONTRACT_IDENTITY_INVALID');
  }
  ...
  ], 'PATCH83U_RUN008_PROOF_TARGETS_INVALID');
  if (
    ...
    fail('PATCH83U_RUN008_PROOF_TARGETS_INVALID');
  }
  ...
  const runtime = exactKeys(contract.runtime_contract, [
    ...
    'required_migrations',
    'stable_finalizer',
  ], 'PATCH83U_RUN008_RUNTIME_CONTRACT_INVALID');
  if (
    ...
    fail('PATCH83U_RUN008_RUNTIME_CONTRACT_INVALID');
  }
  exactStringArray(
  ...
  const edge = exactKeys(contract.edge_contract, [
    ...
    'source_sha256',
    'source_bytes',
  ], 'PATCH83U_RUN008_EDGE_CONTRACT_INVALID');
  if (
    ...
    fail('PATCH83U_RUN008_EDGE_CONTRACT_INVALID');
  }
  ...
  const confirmation = exactKeys(contract.confirmation_contract, [
    ...
    'evidence_retention',
  ], 'PATCH83U_RUN008_CONFIRMATION_CONTRACT_INVALID');
  if (
    confirmation.contract_id !== RUN008_CONFIRMATION_CONTRACT_ID
    || confirmation.exact_phrase !== RUN008_CONFIRMATION_PHRASE
    ...
    fail('PATCH83U_RUN008_CONFIRMATION_CONTRACT_INVALID');
  }
  ...
  const finalSession = exactKeys(contract.final_session_contract, [
    ...
    'cli_override_supported',
    'justification_basis',
  ], 'PATCH83U_RUN008_FINAL_SESSION_CONTRACT_INVALID');
  if (
    finalSession.checkpoint !== 'after_fresh_employee_login'
    || finalSession.expected_session_count !== RUN008_EXPECTED_SESSION_COUNT
    || finalSession.expected_unrevoked_refresh_token_count
      !== RUN008_EXPECTED_UNREVOKED_REFRESH_TOKEN_COUNT
    || finalSession.enforcement !== 'exact_integer_equality'
    || finalSession.cli_override_supported !== false
  ) {
    fail('PATCH83U_RUN008_FINAL_SESSION_CONTRACT_INVALID');
  }
  nonEmptyString(
    finalSession.justification_basis,
    'PATCH83U_RUN008_FINAL_SESSION_JUSTIFICATION_MISSING',
  );

  const checkpointContracts = objectValue(
    contract.checkpoint_contracts,
    'PATCH83U_RUN008_CHECKPOINT_CONTRACTS_INVALID',
  );
  exactStringArray(
  ...
  for (const checkpoint of CHECKPOINT_NAMES) {
    const checkpointContract = objectValue(
      ...
      'PATCH83U_RUN008_CHECKPOINT_CONTRACT_INVALID',
    );
    if (
      ...
      fail('PATCH83U_RUN008_CHECKPOINT_CONTRACT_INVALID', checkpoint);
    }
  }
  const expectedVersions = {
    before_employee_sessions: RUN008_INITIAL_CREDENTIAL_VERSION,
    immediately_before_reset: RUN008_INITIAL_CREDENTIAL_VERSION,
    immediately_after_reset: RUN008_POST_RESET_CREDENTIAL_VERSION,
    before_required_password_change: RUN008_POST_RESET_CREDENTIAL_VERSION,
    immediately_after_password_change_finalization:
      RUN008_FINAL_CREDENTIAL_VERSION,
    after_fresh_employee_login: RUN008_FINAL_CREDENTIAL_VERSION,
  };
  for (const [checkpoint, expectedVersion] of Object.entries(expectedVersions)) {
    ...
    assertExpectedTargetValue(
      ...
      'credential_version',
      expectedVersion,
      'PATCH83U_RUN008_CREDENTIAL_BASELINE_INVALID',
    );
    assertExpectedTargetValue(
      expected,
  ...
  assertExpectedTargetValue(
    ...
    'session_count',
    0,
    'PATCH83U_RUN008_INITIAL_SESSION_COUNT_INVALID',
  );
  assertExpectedTargetValue(
    initial,
    'unrevoked_refresh_token_count',
    0,
    'PATCH83U_RUN008_INITIAL_REFRESH_COUNT_INVALID',
  );
  const finalization =
  ...
  for (const field of [
    ...
    if (!finalization.required_target_fields.includes(field)) {
      fail('PATCH83U_RUN008_CHECKPOINT5_FIELD_MISSING', field);
    }
  }
  assertExpectedTargetValue(
    ...
    'password_changed_at_set',
    true,
    'PATCH83U_RUN008_PASSWORD_CHANGED_AT_CONTRACT_INVALID',
  );
  assertExpectedTargetValue(
    finalization.expected,
    'sessions_revoked_at_set',
    true,
    'PATCH83U_RUN008_SESSIONS_REVOKED_AT_CONTRACT_INVALID',
  );
  assertExpectedTargetValue(
    finalization.expected,
    'reconciliation_auth_changed',
    false,
    'PATCH83U_RUN008_RECONCILIATION_CONTRACT_INVALID',
  );
  for (const checkpoint of CHECKPOINT_NAMES.filter((name) => (
    ...
    if (
      ...
      fail('PATCH83U_RUN008_FINALIZATION_FIELD_PHASE_LEAK', checkpoint);
    }
  }
  ...
  assertExpectedTargetValue(
    ...
    'session_count',
    1,
    'PATCH83U_RUN008_TEMPORARY_SESSION_CONTRACT_INVALID',
  );
  assertExpectedTargetValue(
    temporaryLogin.expected,
    'unrevoked_refresh_token_count',
  ...
  ], 'PATCH83U_RUN008_EVIDENCE_CONTRACT_INVALID');
  if (
    evidence.schema_version !== 'patch83u-staging-reset-proof-v7'
    || evidence.redacted_only !== true
    || !Array.isArray(evidence.prohibited_keys)
    || !Array.isArray(evidence.permitted_value_classes)
  ) {
    fail('PATCH83U_RUN008_EVIDENCE_CONTRACT_INVALID');
  }
  for (const prohibited of [
    ...
    if (!evidence.prohibited_keys.includes(prohibited)) {
      fail('PATCH83U_RUN008_EVIDENCE_EXCLUSION_MISSING', prohibited);
    }
  }

  if (!Array.isArray(contract.phases) || contract.phases.length !== 14) {
    fail('PATCH83U_RUN008_PHASE_CONTRACT_INCOMPLETE');
  }
  for (let index = 0; index < contract.phases.length; index += 1) {
    const phase = exactKeys(contract.phases[index], [
      ...
      'name',
      'requirements',
    ], 'PATCH83U_RUN008_PHASE_CONTRACT_INVALID');
    if (
      phase.phase !== index + 1
      ...
      fail('PATCH83U_RUN008_PHASE_CONTRACT_INVALID', String(index + 1));
    }
    for (const requirement of phase.requirements) {
      exactKeys(
        requirement,
        ['id', 'condition'],
        'PATCH83U_RUN008_REQUIREMENT_SHAPE_INVALID',
      );
      nonEmptyString(
        requirement.condition,
        'PATCH83U_RUN008_REQUIREMENT_CONDITION_MISSING',
      );
      if (!new RegExp(`^R008_P${String(phase.phase).padStart(2, '0')}_[A-Z0-9_]+$`)
        .test(requirement.id)) {
        fail('PATCH83U_RUN008_REQUIREMENT_ID_INVALID', requirement.id);
      }
    }
  }
  ...
  if (
    ids.length !== RUN008_REQUIRED_REQUIREMENT_IDS.length
    || new Set(ids).size !== ids.length
    || RUN008_REQUIRED_REQUIREMENT_IDS.some((id) => !ids.includes(id))
  ) {
    fail('PATCH83U_RUN008_REQUIRED_REQUIREMENTS_INCOMPLETE');
  }
...
export function validateRun008Traceability(traceability, proofContract) {
  const proofValidation = validateRun008ProofContract(proofContract);
  exactKeys(traceability, [
    ...
    'complete',
    'requirements',
  ], 'PATCH83U_RUN008_TRACEABILITY_SHAPE_INVALID');
  if (
    traceability.schema_version !== RUN008_TRACEABILITY_VERSION
    || traceability.contract_id !== RUN008_PROOF_CONTRACT_ID
    || traceability.run_number !== 8
    ...
    fail('PATCH83U_RUN008_TRACEABILITY_SUMMARY_INVALID');
  }
  ...
  for (const row of traceability.requirements) {
    exactKeys(row, [
      ...
      'failure_code',
      'evidence_field',
    ], 'PATCH83U_RUN008_TRACEABILITY_ROW_SHAPE_INVALID');
    const proofRequirement = proofRequirements.get(row.requirement_id);
    if (!proofRequirement || seen.has(row.requirement_id)) {
      fail('PATCH83U_RUN008_TRACEABILITY_REQUIREMENT_INVALID', row.requirement_id);
    }
    ...
    if (
      ...
      fail('PATCH83U_RUN008_TRACEABILITY_MAPPING_INVALID', row.requirement_id);
    }
    for (const [field, code] of [
      ['schema_path', 'PATCH83U_RUN008_TRACEABILITY_SCHEMA_PATH_MISSING'],
      ['harness_assertion', 'PATCH83U_RUN008_TRACEABILITY_ASSERTION_MISSING'],
      ['unit_test', 'PATCH83U_RUN008_TRACEABILITY_TEST_MISSING'],
      ['evidence_field', 'PATCH83U_RUN008_TRACEABILITY_EVIDENCE_FIELD_MISSING'],
    ]) {
      nonEmptyString(row[field], code);
    }
    if (!SAFE_FAILURE_CODE_PATTERN.test(row.failure_code)) {
      fail('PATCH83U_RUN008_TRACEABILITY_FAILURE_CODE_INVALID', row.requirement_id);
    }
  }
  if (
    seen.size !== RUN008_REQUIRED_REQUIREMENT_IDS.length
    || RUN008_REQUIRED_REQUIREMENT_IDS.some((id) => !seen.has(id))
  ) {
    fail('PATCH83U_RUN008_TRACEABILITY_INCOMPLETE');
  }
  return Object.freeze({
    passed: true,
...
function checkpointSqlBlocks(sql) {
  ...
  for (let index = 0; index < starts.length; index += 1) {
    ...
    if (blocks.has(number)) {
      fail('PATCH83U_RUN008_SQL_CHECKPOINT_BLOCK_DUPLICATE', String(number));
    }
  ...
  if (
    ...
    fail('PATCH83U_RUN008_SQL_CHECKPOINT_BLOCK_INCOMPLETE');
  }
  return blocks;
}
...
function checkpointTargetSql(block, checkpoint) {
  ...
  if (
    ...
    fail('PATCH83U_RUN008_SQL_TARGET_EMISSION_MISSING', checkpoint);
  }
  return match[1];
}
...
function checkpointSchemaBranch(rootSchema, checkpoint) {
  if (!Array.isArray(rootSchema.oneOf)) {
    fail('PATCH83U_RUN008_CHECKPOINT_SCHEMA_ONE_OF_REQUIRED');
  }
  const candidates = rootSchema.oneOf
    .map((node) => schemaReferenceTarget(
      rootSchema,
      node,
      'PATCH83U_RUN008_CHECKPOINT_SCHEMA_REF_INVALID',
    ))
    .filter((branch) => {
  ...
  if (candidates.length !== 1) {
    fail(
      'PATCH83U_RUN008_CHECKPOINT_SCHEMA_PHASE_BRANCH_NOT_EXACT',
      checkpoint,
    );
  }
  return candidates[0];
...
function assertExpectedFieldSchema(
  ...
  if (expectedField.startsWith('minimum_')) {
    ...
    if (
      ...
      fail(
        'PATCH83U_RUN008_CHECKPOINT_SCHEMA_MINIMUM_NOT_BOUND',
  ...
  if (fieldSchema.const !== expectedValue) {
    fail(
      'PATCH83U_RUN008_CHECKPOINT_SCHEMA_EXPECTATION_NOT_EXACT',
...
function auditCheckpointContractsAgainstSqlAndSchema({
  ...
  for (const checkpoint of CHECKPOINT_NAMES) {
    ...
    if (
      ...
      fail('PATCH83U_RUN008_CHECKPOINT_SCHEMA_TARGET_REQUIRED', checkpoint);
    }
    const targetSchema = schemaReferenceTarget(
      checkpointSchema,
      targetProperty,
      'PATCH83U_RUN008_CHECKPOINT_TARGET_SCHEMA_REF_INVALID',
    );
    if (
      ...
      fail('PATCH83U_RUN008_CHECKPOINT_TARGET_SCHEMA_OPEN', checkpoint);
    }

    for (const field of contract.required_target_fields) {
      if (!new RegExp(`\\b${escapeRegularExpression(field)}\\b`).test(targetSql)) {
        fail(
          'PATCH83U_RUN008_CHECKPOINT_SQL_TARGET_FIELD_MISSING',
          `${checkpoint}.${field}`,
        );
      }
      if (
        ...
        fail(
          'PATCH83U_RUN008_CHECKPOINT_SCHEMA_TARGET_FIELD_MISSING',
          `${checkpoint}.${field}`,
        );
      }
    ...
    for (const [expectedField, expectedValue] of Object.entries(expectations)) {
      ...
      if (
        ...
        fail(
          'PATCH83U_RUN008_CHECKPOINT_EXPECTED_FIELD_NOT_REQUIRED',
          `${checkpoint}.${targetField}`,
        );
      }
      const fieldSchema = schemaReferenceTarget(
        ...
        'PATCH83U_RUN008_CHECKPOINT_FIELD_SCHEMA_REF_INVALID',
      );
      if (contract.required_for_every_reset_outcome === true) {
        if (
          ...
          fail(
            'PATCH83U_RUN008_CHECKPOINT_CONDITIONAL_SUCCESS_NOT_ENFORCED',
            `${checkpoint}.${targetField}`,
          );
        }
...
function assertSqlCheckpointMapping(mapping, blocks, requirementId) {
  ...
  const match = /^checkpoint_([1-6])(?:\.([a-z_][a-z0-9_]*))?\.([a-z_][a-z0-9_]*)$/
    .exec(mapping);
  if (!match) {
    fail('PATCH83U_RUN008_TRACEABILITY_SQL_FIELD_INVALID', requirementId);
  }
  ...
  if (
    ...
    fail('PATCH83U_RUN008_TRACEABILITY_SQL_FIELD_UNRESOLVED', requirementId);
  }
}

export async function auditRun008StaticCoverage({
  traceability,
  proofContract,
  repositoryRoot = process.cwd(),
} = {}) {
  objectValue(traceability, 'PATCH83U_RUN008_TRACEABILITY_REQUIRED');
  objectValue(proofContract, 'PATCH83U_RUN008_PROOF_CONTRACT_REQUIRED');
  const [harnessBytes, sqlBytes, auditBytes] = await Promise.all([
    readRepositoryArtifact(
      repositoryRoot,
      RUN008_HARNESS_PATH,
      'PATCH83U_RUN008_HARNESS_PATH_REFUSED',
    ),
    readRepositoryArtifact(
      repositoryRoot,
      RUN008_SQL_CHECKPOINT_PATH,
      'PATCH83U_RUN008_SQL_PATH_REFUSED',
    ),
    readRepositoryArtifact(
      repositoryRoot,
      'scripts/patch83u-run008-contract-audit.mjs',
      'PATCH83U_RUN008_AUDIT_PATH_REFUSED',
    ),
  ]);
  ...
  const sourceCache = new Map([
    [RUN008_HARNESS_PATH, harnessSource],
    ['scripts/patch83u-run008-contract-audit.mjs', auditSource],
  ]);
  let covered = 0;
  ...
  for (const row of traceability.requirements) {
    await resolveArtifactJsonPointer(
      ...
      row.schema_path,
      {
        pathCode: 'PATCH83U_RUN008_TRACEABILITY_SCHEMA_PATH_REFUSED',
        jsonCode: 'PATCH83U_RUN008_TRACEABILITY_SCHEMA_JSON_INVALID',
        pointerCode: 'PATCH83U_RUN008_TRACEABILITY_SCHEMA_POINTER_UNRESOLVED',
        cache: jsonCache,
      },
    );
    await resolveArtifactJsonPointer(
      ...
      row.evidence_field,
      {
        pathCode: 'PATCH83U_RUN008_TRACEABILITY_EVIDENCE_PATH_REFUSED',
        jsonCode: 'PATCH83U_RUN008_TRACEABILITY_EVIDENCE_JSON_INVALID',
        pointerCode: 'PATCH83U_RUN008_TRACEABILITY_EVIDENCE_POINTER_UNRESOLVED',
        cache: jsonCache,
      },
    );
    ...
    if (
      ...
      fail(
        'PATCH83U_RUN008_TRACEABILITY_ASSERTION_UNRESOLVED',
        row.requirement_id,
      );
    }
    ...
    const testReference = splitArtifactPointer(
      row.unit_test,
      'PATCH83U_RUN008_TRACEABILITY_TEST_REFERENCE_INVALID',
    );
    ...
    if (!testSource) {
      const testBytes = await readRepositoryArtifact(
        repositoryRoot,
        testReference.path,
        'PATCH83U_RUN008_TRACEABILITY_TEST_PATH_REFUSED',
      );
    ...
    if (
      ...
      fail('PATCH83U_RUN008_TRACEABILITY_TEST_UNRESOLVED', row.requirement_id);
    }
    ...
    if (
      ...
      fail(
        'PATCH83U_RUN008_TRACEABILITY_FAILURE_CODE_UNRESOLVED',
        row.requirement_id,
      );
    }
    covered += 1;
  }
  if (covered !== RUN008_REQUIRED_REQUIREMENT_IDS.length) {
    fail('PATCH83U_RUN008_STATIC_COVERAGE_INCOMPLETE');
  }
  const checkpointSchemaBytes = await readRepositoryArtifact(
    repositoryRoot,
    RUN008_CHECKPOINT_SCHEMA_PATH,
    'PATCH83U_RUN008_CHECKPOINT_SCHEMA_PATH_REFUSED',
  );
  let checkpointSchema;
  try {
    checkpointSchema = JSON.parse(checkpointSchemaBytes.toString('utf8'));
  } catch {
    fail('PATCH83U_RUN008_CHECKPOINT_SCHEMA_JSON_INVALID');
  }
...
export async function verifyRun008ContractArtifacts({
  freeze,
  repositoryRoot = process.cwd(),
} = {}) {
  objectValue(freeze, 'PATCH83U_RUN008_FREEZE_REQUIRED');
  const proofBinding = objectValue(
    freeze.proof_contract,
    'PATCH83U_RUN008_PROOF_BINDING_REQUIRED',
  );
  const traceabilityBinding = objectValue(
    freeze.traceability,
    'PATCH83U_RUN008_TRACEABILITY_BINDING_REQUIRED',
  );
  const checkpointSchemaBinding = objectValue(
    freeze.checkpoint_schema,
    'PATCH83U_RUN008_CHECKPOINT_SCHEMA_BINDING_REQUIRED',
  );
  const runContract = objectValue(
    freeze.run_contract,
    'PATCH83U_RUN008_RUN_CONTRACT_REQUIRED',
  );
  const [proofArtifact, traceabilityArtifact, markdownArtifact,
    ...
    await Promise.all([
      readBoundArtifact(
        repositoryRoot,
        RUN008_PROOF_CONTRACT_PATH,
        proofBinding.path,
        'PATCH83U_RUN008_PROOF_CONTRACT_PATH_REFUSED',
      ),
      readBoundArtifact(
        repositoryRoot,
        RUN008_TRACEABILITY_PATH,
        traceabilityBinding.json_path,
        'PATCH83U_RUN008_TRACEABILITY_PATH_REFUSED',
      ),
      readBoundArtifact(
        repositoryRoot,
        RUN008_TRACEABILITY_MARKDOWN_PATH,
        traceabilityBinding.markdown_path,
        'PATCH83U_RUN008_TRACEABILITY_MARKDOWN_PATH_REFUSED',
      ),
      readBoundArtifact(
        repositoryRoot,
        RUN008_CHECKPOINT_SCHEMA_PATH,
      ...
      readBoundArtifact(
        repositoryRoot,
        RUN008_EVIDENCE_SCHEMA_PATH,
        runContract.evidence_schema_path,
        'PATCH83U_RUN008_EVIDENCE_SCHEMA_PATH_REFUSED',
      ),
    ]);
  ...
  if (
    ...
    fail('PATCH83U_RUN008_PROOF_CONTRACT_HASH_MISMATCH');
  }
  if (
    ...
    fail('PATCH83U_RUN008_TRACEABILITY_HASH_MISMATCH');
  }
  if (
    ...
    fail('PATCH83U_RUN008_TRACEABILITY_MARKDOWN_HASH_MISMATCH');
  }
  if (
    ...
    fail('PATCH83U_RUN008_CHECKPOINT_SCHEMA_HASH_MISMATCH');
  }
  if (
    ...
    fail('PATCH83U_RUN008_EVIDENCE_SCHEMA_HASH_MISMATCH');
  }
  ...
  try {
    ...
    fail('PATCH83U_RUN008_PROOF_CONTRACT_JSON_INVALID');
  }
  try {
    traceability = JSON.parse(traceabilityArtifact.bytes.toString('utf8'));
  } catch {
    fail('PATCH83U_RUN008_TRACEABILITY_JSON_INVALID');
  }
  const proofValidation = validateRun008ProofContract(proofContract);
  const traceabilityValidation =
    validateRun008Traceability(traceability, proofContract);
  const staticCoverage = await auditRun008StaticCoverage({
    traceability,
    proofContract,
    repositoryRoot,
  });
  const markdown = markdownArtifact.bytes.toString('utf8');
  for (const requirementId of RUN008_REQUIRED_REQUIREMENT_IDS) {
    if (!markdown.includes(requirementId)) {
      fail('PATCH83U_RUN008_TRACEABILITY_MARKDOWN_INCOMPLETE', requirementId);
    }
  }
  if (
    proofBinding.schema_version !== RUN008_PROOF_CONTRACT_VERSION
    || proofBinding.contract_id !== RUN008_PROOF_CONTRACT_ID
    || proofBinding.requirement_count !== proofValidation.requirement_count
    || traceabilityBinding.schema_version !== RUN008_TRACEABILITY_VERSION
    ...
    || runContract.evidence_schema_version
      !== 'patch83u-staging-reset-proof-v7'
    || staticCoverage.static_coverage_count !== proofValidation.requirement_count
  ) {
    fail('PATCH83U_RUN008_CONTRACT_FREEZE_BINDING_INVALID');
  }
  ...
  if (
    ...
    fail('PATCH83U_RUN008_FINAL_SESSION_FREEZE_BINDING_MISMATCH');
  }
  ...
  if (
    ...
    fail('PATCH83U_RUN008_CONFIRMATION_FREEZE_BINDING_MISMATCH');
  }
  return Object.freeze({
    passed: true,
    requirement_count: proofValidation.requirement_count,
...
async function main() {
  ...
  const [proofContract, traceability] = await Promise.all([
    readFile(resolve(root, RUN008_PROOF_CONTRACT_PATH), 'utf8').then(JSON.parse),
    readFile(resolve(root, RUN008_TRACEABILITY_PATH), 'utf8').then(JSON.parse),
  ]);
  const result = validateRun008Traceability(traceability, proofContract);
  const staticCoverage = await auditRun008StaticCoverage({
    traceability,
    proofContract,
    repositoryRoot: root,
  ...
  process.stdout.write(
    `PATCH83U RUN008 CONTRACT TRACEABILITY PASSED `
...
if (process.argv[1] && resolve(process.argv[1]) === fileURLToPath(import.meta.url)) {
  main().catch((error) => {
    process.stderr.write(
      `${error instanceof Error ? error.message : 'PATCH83U_RUN008_CONTRACT_AUDIT_FAILED'}\n`,
    );
    process.exitCode = 1;
  });
}
