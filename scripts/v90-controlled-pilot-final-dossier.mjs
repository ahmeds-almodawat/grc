...
const rows = [
  [
    "Technical evidence",
    "Summarize typecheck, build, runtime security, persona proof, restore proof, and repo health",
    "Project Lead",
    "Ready"
  ],
  [
    "Operational evidence",
    "Summarize pilot console, issue log, monitoring, access review, and closeout dashboard",
    "Pilot Operator",
    "Ready"
  ],
  [
    "Human approval",
    "Management/Admin, IT, Quality, and confidentiality confirmation",
    "Approvers",
    "Pending"
  ],
  [
    "Controlled pilot decision",
    "Approve / defer / reject controlled internal pilot",
    "Management",
    "Pending"
  ],
  [
    "Production decision",
    "Explicitly not production-ready until live staging and production proof are completed",
    "Management / IT",
    "Not ready"
  ]
];
...
console.log(JSON.stringify({
  ...
  report: 'release/v90/v90-controlled-pilot-final-dossier.md'
}, null, 2));
