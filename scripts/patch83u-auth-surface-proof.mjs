...
export function analyzePatch83uAuthSurface({
  ...
  const reviewedPatch83uMigrationCeiling = 197;
  ...
  return {
    ...
    evidence: {
      ...
      target_schema: 'ordered supabase/migrations/*.sql through reviewed migration 197',
      ...
      note: 'Static target-schema proof through reviewed migration 197. No hosted catalog state is claimed.',
    },
    summary: {
