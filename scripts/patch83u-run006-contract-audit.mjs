...
export const RUN006_PROOF_CONTRACT_PATH =
  'release/patch83u/patch83u-run006-proof-contract.json';
export const RUN006_TRACEABILITY_PATH =
  'release/patch83u/patch83u-run006-proof-traceability.json';
export const RUN006_TRACEABILITY_MARKDOWN_PATH =
  'release/patch83u/patch83u-run006-proof-traceability.md';
export const RUN006_CHECKPOINT_SCHEMA_PATH =
  'release/patch83u/patch83u-staging-checkpoint-file-schema-v2.json';
export const RUN006_EVIDENCE_SCHEMA_PATH =
  'release/patch83u/patch83u-staging-reset-harness-schema-v5.json';
export const RUN006_HARNESS_PATH =
  'scripts/patch83u-staging-multisession-reset-proof.mjs';
export const RUN006_SQL_CHECKPOINT_PATH =
  'scripts/patch83u-staging-sql-editor-evidence.sql';
export const RUN006_PROOF_CONTRACT_VERSION = 'patch83u-run006-proof-contract-v1';
export const RUN006_PROOF_CONTRACT_ID = 'patch83u-hosted-reset-proof-run-006';
export const RUN006_TRACEABILITY_VERSION = 'patch83u-run006-proof-traceability-v1';
export const RUN006_CONFIRMATION_CONTRACT_ID =
  'patch83u-run006-reset-confirmation-v1';
export const RUN006_CONFIRMATION_PHRASE = 'EXECUTE RUN 006 RESET NOW';
export const RUN006_EXPECTED_SESSION_COUNT = 1;
export const RUN006_EXPECTED_UNREVOKED_REFRESH_TOKEN_COUNT = 1;
...
export const RUN006_REQUIRED_REQUIREMENT_IDS = Object.freeze([
  'R006_P01_STAGING_AND_PRODUCTION_BOUNDARY',
  'R006_P01_FRONTEND_ORIGIN_EXACT',
  'R006_P01_FREEZE_AND_EDGE_PROVENANCE_EXACT',
  'R006_P01_RUNTIME_AND_CONTRACTS_EXACT',
  'R006_P01_PROOF_ARTIFACT_HASHES_EXACT',
  'R006_P01_TRACEABILITY_COMPLETE',
  'R006_P01_CONFIRMATION_AND_COUNT_CONTRACTS_FROZEN',
  'R006_P01_EVIDENCE_EXCLUSIONS_ACTIVE',
  'R006_P02_CHECKPOINT1_READ_ONLY',
  'R006_P02_INITIAL_EMPLOYEE_STATE',
  'R006_P02_INITIAL_ADMIN_STATE',
  'R006_P02_FINALIZER_AND_RECOVERY_READY',
  'R006_P03_ADMIN_CONTEXTS_READY',
  'R006_P03_TWO_EMPLOYEE_SESSIONS',
  'R006_P03_BOTH_REFRESHES_SUCCEED',
  'R006_P03_EMPLOYEE_AUTHORIZATION_PROVEN',
  'R006_P04_CHECKPOINT2_READ_ONLY',
  'R006_P04_TARGET_PRE_RESET_UNCHANGED',
  'R006_P04_ADMIN_AND_RUNTIME_UNCHANGED',
  'R006_P05_EXACT_RESET_CONFIRMATIONS',
  'R006_P05_ONE_SHOT_RESET',
  'R006_P05_STABLE_REQUEST_CORRELATION',
  'R006_P05_AMBIGUOUS_RESET_NO_RETRY',
  'R006_P06_CHECKPOINT3_ALWAYS',
  'R006_P06_RESET_OUTCOME_CLASSIFIED',
  'R006_P06_PROTECTED_STATE_FAIL_CLOSED',
  'R006_P07_RESET_SUCCESS_STATE_V3',
  'R006_P07_RESET_ZERO_SESSIONS',
  'R006_P07_RESET_GOVERNANCE_AND_AUDIT',
  'R006_P08_OLD_PASSWORD_REJECTED',
  'R006_P08_BOTH_REFRESH_REPLAYS_REJECTED',
  'R006_P08_BOTH_STALE_CONTEXTS_DENIED',
  'R006_P09_TEMPORARY_LOGIN_SUCCEEDS',
  'R006_P09_FORCED_CHANGE_ONLY',
  'R006_P10_CHECKPOINT4_READ_ONLY',
  'R006_P10_PRE_CHANGE_STATE_V3_WITH_TEMP_SESSION',
  'R006_P11_REQUIRED_CHANGE_ACTION_EXACT',
  'R006_P11_SECRET_AND_POLICY_CONTROLS',
  'R006_P11_GLOBAL_SIGNOUT_AND_FINALIZER',
  'R006_P11_NO_AUTO_RECOVERY_ACTION',
  'R006_P12_CHECKPOINT5_READ_ONLY',
  'R006_P12_FINAL_ACTIVE_V4_ZERO',
  'R006_P12_PASSWORD_CHANGED_AT_SET',
  'R006_P12_SESSIONS_REVOKED_AT_SET',
  'R006_P12_GOVERNANCE_AND_RECONCILIATION_CLEARED',
  'R006_P12_PASSWORD_CHANGE_AUDIT_CORRELATED',
  'R006_P12_BROWSER_SIGNED_OUT',
  'R006_P13_FRESH_PERMANENT_LOGIN',
  'R006_P13_EMPLOYEE_ROLE_SCOPE_PRESERVED',
  'R006_P13_DIRECT_ADMIN_DENIED',
  'R006_P13_NETWORK_CONSOLE_SAFE',
  'R006_P14_CHECKPOINT6_READ_ONLY',
  'R006_P14_EXACT_FINAL_SESSION_COUNT',
  'R006_P14_EXACT_FINAL_REFRESH_COUNT',
  'R006_P14_ADMIN_AND_RUNTIME_UNCHANGED',
  'R006_P14_REDACTED_EVIDENCE_VALID',
]);
...
export function validateRun006ProofContract(contract) {
  exactKeys(contract, [
    'schema_version',
    'contract_id',
    'run_number',
    ...
    'evidence_contract',
    'phases',
  ], 'PATCH83U_RUN006_PROOF_CONTRACT_SHAPE_INVALID');
  if (
    contract.schema_version !== RUN006_PROOF_CONTRACT_VERSION
    || contract.contract_id !== RUN006_PROOF_CONTRACT_ID
    || contract.run_number !== 6
    || contract.decision_is_execution_authorization !== false
  ) {
    fail('PATCH83U_RUN006_PROOF_CONTRACT_IDENTITY_INVALID');
  }
  ...
  ], 'PATCH83U_RUN006_PROOF_TARGETS_INVALID');
  if (
    ...
    fail('PATCH83U_RUN006_PROOF_TARGETS_INVALID');
  }
  ...
  const runtime = exactKeys(contract.runtime_contract, [
    ...
    'required_migrations',
    'stable_finalizer',
  ], 'PATCH83U_RUN006_RUNTIME_CONTRACT_INVALID');
  if (
    ...
    fail('PATCH83U_RUN006_RUNTIME_CONTRACT_INVALID');
  }
  exactStringArray(
  ...
  const edge = exactKeys(contract.edge_contract, [
    ...
    'source_sha256',
    'source_bytes',
  ], 'PATCH83U_RUN006_EDGE_CONTRACT_INVALID');
  if (
    ...
    fail('PATCH83U_RUN006_EDGE_CONTRACT_INVALID');
  }
  ...
  const confirmation = exactKeys(contract.confirmation_contract, [
    ...
    'evidence_retention',
  ], 'PATCH83U_RUN006_CONFIRMATION_CONTRACT_INVALID');
  if (
    confirmation.contract_id !== RUN006_CONFIRMATION_CONTRACT_ID
    || confirmation.exact_phrase !== RUN006_CONFIRMATION_PHRASE
    ...
    fail('PATCH83U_RUN006_CONFIRMATION_CONTRACT_INVALID');
  }
  ...
  const finalSession = exactKeys(contract.final_session_contract, [
    ...
    'cli_override_supported',
    'justification_basis',
  ], 'PATCH83U_RUN006_FINAL_SESSION_CONTRACT_INVALID');
  if (
    finalSession.checkpoint !== 'after_fresh_employee_login'
    || finalSession.expected_session_count !== RUN006_EXPECTED_SESSION_COUNT
    || finalSession.expected_unrevoked_refresh_token_count
      !== RUN006_EXPECTED_UNREVOKED_REFRESH_TOKEN_COUNT
    || finalSession.enforcement !== 'exact_integer_equality'
    || finalSession.cli_override_supported !== false
  ) {
    fail('PATCH83U_RUN006_FINAL_SESSION_CONTRACT_INVALID');
  }
  nonEmptyString(
    finalSession.justification_basis,
    'PATCH83U_RUN006_FINAL_SESSION_JUSTIFICATION_MISSING',
  );

  const checkpointContracts = objectValue(
    contract.checkpoint_contracts,
    'PATCH83U_RUN006_CHECKPOINT_CONTRACTS_INVALID',
  );
  exactStringArray(
  ...
  for (const checkpoint of CHECKPOINT_NAMES) {
    const checkpointContract = objectValue(
      ...
      'PATCH83U_RUN006_CHECKPOINT_CONTRACT_INVALID',
    );
    if (
      ...
      fail('PATCH83U_RUN006_CHECKPOINT_CONTRACT_INVALID', checkpoint);
    }
  }
  const finalization =
  ...
  for (const field of [
    ...
    if (!finalization.required_target_fields.includes(field)) {
      fail('PATCH83U_RUN006_CHECKPOINT5_FIELD_MISSING', field);
    }
  }
  assertExpectedTargetValue(
    ...
    'password_changed_at_set',
    true,
    'PATCH83U_RUN006_PASSWORD_CHANGED_AT_CONTRACT_INVALID',
  );
  assertExpectedTargetValue(
    finalization.expected,
    'sessions_revoked_at_set',
    true,
    'PATCH83U_RUN006_SESSIONS_REVOKED_AT_CONTRACT_INVALID',
  );
  assertExpectedTargetValue(
    finalization.expected,
    'reconciliation_auth_changed',
    false,
    'PATCH83U_RUN006_RECONCILIATION_CONTRACT_INVALID',
  );
  for (const checkpoint of CHECKPOINT_NAMES.filter((name) => (
    ...
    if (
      ...
      fail('PATCH83U_RUN006_FINALIZATION_FIELD_PHASE_LEAK', checkpoint);
    }
  }
  ...
  assertExpectedTargetValue(
    ...
    'session_count',
    1,
    'PATCH83U_RUN006_TEMPORARY_SESSION_CONTRACT_INVALID',
  );
  assertExpectedTargetValue(
    temporaryLogin.expected,
  ...
  ], 'PATCH83U_RUN006_EVIDENCE_CONTRACT_INVALID');
  if (
    evidence.schema_version !== 'patch83u-staging-reset-proof-v5'
    || evidence.redacted_only !== true
    || !Array.isArray(evidence.prohibited_keys)
    || !Array.isArray(evidence.permitted_value_classes)
  ) {
    fail('PATCH83U_RUN006_EVIDENCE_CONTRACT_INVALID');
  }
  for (const prohibited of [
    ...
    if (!evidence.prohibited_keys.includes(prohibited)) {
      fail('PATCH83U_RUN006_EVIDENCE_EXCLUSION_MISSING', prohibited);
    }
  }

  if (!Array.isArray(contract.phases) || contract.phases.length !== 14) {
    fail('PATCH83U_RUN006_PHASE_CONTRACT_INCOMPLETE');
  }
  for (let index = 0; index < contract.phases.length; index += 1) {
    const phase = exactKeys(contract.phases[index], [
      ...
      'name',
      'requirements',
    ], 'PATCH83U_RUN006_PHASE_CONTRACT_INVALID');
    if (
      phase.phase !== index + 1
      ...
      fail('PATCH83U_RUN006_PHASE_CONTRACT_INVALID', String(index + 1));
    }
    for (const requirement of phase.requirements) {
      exactKeys(
        requirement,
        ['id', 'condition'],
        'PATCH83U_RUN006_REQUIREMENT_SHAPE_INVALID',
      );
      nonEmptyString(
        requirement.condition,
        'PATCH83U_RUN006_REQUIREMENT_CONDITION_MISSING',
      );
      if (!new RegExp(`^R006_P${String(phase.phase).padStart(2, '0')}_[A-Z0-9_]+$`)
        .test(requirement.id)) {
        fail('PATCH83U_RUN006_REQUIREMENT_ID_INVALID', requirement.id);
      }
    }
  }
  ...
  if (
    ids.length !== RUN006_REQUIRED_REQUIREMENT_IDS.length
    || new Set(ids).size !== ids.length
    || RUN006_REQUIRED_REQUIREMENT_IDS.some((id) => !ids.includes(id))
  ) {
    fail('PATCH83U_RUN006_REQUIRED_REQUIREMENTS_INCOMPLETE');
  }
...
export function validateRun006Traceability(traceability, proofContract) {
  const proofValidation = validateRun006ProofContract(proofContract);
  exactKeys(traceability, [
    ...
    'complete',
    'requirements',
  ], 'PATCH83U_RUN006_TRACEABILITY_SHAPE_INVALID');
  if (
    traceability.schema_version !== RUN006_TRACEABILITY_VERSION
    || traceability.contract_id !== RUN006_PROOF_CONTRACT_ID
    || traceability.run_number !== 6
    ...
    fail('PATCH83U_RUN006_TRACEABILITY_SUMMARY_INVALID');
  }
  ...
  for (const row of traceability.requirements) {
    exactKeys(row, [
      ...
      'failure_code',
      'evidence_field',
    ], 'PATCH83U_RUN006_TRACEABILITY_ROW_SHAPE_INVALID');
    const proofRequirement = proofRequirements.get(row.requirement_id);
    if (!proofRequirement || seen.has(row.requirement_id)) {
      fail('PATCH83U_RUN006_TRACEABILITY_REQUIREMENT_INVALID', row.requirement_id);
    }
    ...
    if (
      ...
      fail('PATCH83U_RUN006_TRACEABILITY_MAPPING_INVALID', row.requirement_id);
    }
    for (const [field, code] of [
      ['schema_path', 'PATCH83U_RUN006_TRACEABILITY_SCHEMA_PATH_MISSING'],
      ['harness_assertion', 'PATCH83U_RUN006_TRACEABILITY_ASSERTION_MISSING'],
      ['unit_test', 'PATCH83U_RUN006_TRACEABILITY_TEST_MISSING'],
      ['evidence_field', 'PATCH83U_RUN006_TRACEABILITY_EVIDENCE_FIELD_MISSING'],
    ]) {
      nonEmptyString(row[field], code);
    }
    if (!SAFE_FAILURE_CODE_PATTERN.test(row.failure_code)) {
      fail('PATCH83U_RUN006_TRACEABILITY_FAILURE_CODE_INVALID', row.requirement_id);
    }
  }
  if (
    seen.size !== RUN006_REQUIRED_REQUIREMENT_IDS.length
    || RUN006_REQUIRED_REQUIREMENT_IDS.some((id) => !seen.has(id))
  ) {
    fail('PATCH83U_RUN006_TRACEABILITY_INCOMPLETE');
  }
  return Object.freeze({
    passed: true,
...
function checkpointSqlBlocks(sql) {
  ...
  for (let index = 0; index < starts.length; index += 1) {
    ...
    if (blocks.has(number)) {
      fail('PATCH83U_RUN006_SQL_CHECKPOINT_BLOCK_DUPLICATE', String(number));
    }
  ...
  if (
    ...
    fail('PATCH83U_RUN006_SQL_CHECKPOINT_BLOCK_INCOMPLETE');
  }
  return blocks;
}
...
function checkpointTargetSql(block, checkpoint) {
  ...
  if (
    ...
    fail('PATCH83U_RUN006_SQL_TARGET_EMISSION_MISSING', checkpoint);
  }
  return match[1];
}
...
function checkpointSchemaBranch(rootSchema, checkpoint) {
  if (!Array.isArray(rootSchema.oneOf)) {
    fail('PATCH83U_RUN006_CHECKPOINT_SCHEMA_ONE_OF_REQUIRED');
  }
  const candidates = rootSchema.oneOf
    .map((node) => schemaReferenceTarget(
      rootSchema,
      node,
      'PATCH83U_RUN006_CHECKPOINT_SCHEMA_REF_INVALID',
    ))
    .filter((branch) => {
  ...
  if (candidates.length !== 1) {
    fail(
      'PATCH83U_RUN006_CHECKPOINT_SCHEMA_PHASE_BRANCH_NOT_EXACT',
      checkpoint,
    );
  }
  return candidates[0];
...
function assertExpectedFieldSchema(
  ...
  if (expectedField.startsWith('minimum_')) {
    ...
    if (
      ...
      fail(
        'PATCH83U_RUN006_CHECKPOINT_SCHEMA_MINIMUM_NOT_BOUND',
  ...
  if (fieldSchema.const !== expectedValue) {
    fail(
      'PATCH83U_RUN006_CHECKPOINT_SCHEMA_EXPECTATION_NOT_EXACT',
...
function auditCheckpointContractsAgainstSqlAndSchema({
  ...
  for (const checkpoint of CHECKPOINT_NAMES) {
    ...
    if (
      ...
      fail('PATCH83U_RUN006_CHECKPOINT_SCHEMA_TARGET_REQUIRED', checkpoint);
    }
    const targetSchema = schemaReferenceTarget(
      checkpointSchema,
      targetProperty,
      'PATCH83U_RUN006_CHECKPOINT_TARGET_SCHEMA_REF_INVALID',
    );
    if (
      ...
      fail('PATCH83U_RUN006_CHECKPOINT_TARGET_SCHEMA_OPEN', checkpoint);
    }

    for (const field of contract.required_target_fields) {
      if (!new RegExp(`\\b${escapeRegularExpression(field)}\\b`).test(targetSql)) {
        fail(
          'PATCH83U_RUN006_CHECKPOINT_SQL_TARGET_FIELD_MISSING',
          `${checkpoint}.${field}`,
        );
      }
      if (
        ...
        fail(
          'PATCH83U_RUN006_CHECKPOINT_SCHEMA_TARGET_FIELD_MISSING',
          `${checkpoint}.${field}`,
        );
      }
    ...
    for (const [expectedField, expectedValue] of Object.entries(expectations)) {
      ...
      if (
        ...
        fail(
          'PATCH83U_RUN006_CHECKPOINT_EXPECTED_FIELD_NOT_REQUIRED',
          `${checkpoint}.${targetField}`,
        );
      }
      const fieldSchema = schemaReferenceTarget(
        ...
        'PATCH83U_RUN006_CHECKPOINT_FIELD_SCHEMA_REF_INVALID',
      );
      if (contract.required_for_every_reset_outcome === true) {
        if (
          ...
          fail(
            'PATCH83U_RUN006_CHECKPOINT_CONDITIONAL_SUCCESS_NOT_ENFORCED',
            `${checkpoint}.${targetField}`,
          );
        }
...
function assertSqlCheckpointMapping(mapping, blocks, requirementId) {
  ...
  const match = /^checkpoint_([1-6])(?:\.([a-z_][a-z0-9_]*))?\.([a-z_][a-z0-9_]*)$/
    .exec(mapping);
  if (!match) {
    fail('PATCH83U_RUN006_TRACEABILITY_SQL_FIELD_INVALID', requirementId);
  }
  ...
  if (
    ...
    fail('PATCH83U_RUN006_TRACEABILITY_SQL_FIELD_UNRESOLVED', requirementId);
  }
}

export async function auditRun006StaticCoverage({
  traceability,
  proofContract,
  repositoryRoot = process.cwd(),
} = {}) {
  objectValue(traceability, 'PATCH83U_RUN006_TRACEABILITY_REQUIRED');
  objectValue(proofContract, 'PATCH83U_RUN006_PROOF_CONTRACT_REQUIRED');
  const [harnessBytes, sqlBytes, auditBytes] = await Promise.all([
    readRepositoryArtifact(
      repositoryRoot,
      RUN006_HARNESS_PATH,
      'PATCH83U_RUN006_HARNESS_PATH_REFUSED',
    ),
    readRepositoryArtifact(
      repositoryRoot,
      RUN006_SQL_CHECKPOINT_PATH,
      'PATCH83U_RUN006_SQL_PATH_REFUSED',
    ),
    readRepositoryArtifact(
      repositoryRoot,
      'scripts/patch83u-run006-contract-audit.mjs',
      'PATCH83U_RUN006_AUDIT_PATH_REFUSED',
    ),
  ]);
  ...
  const sourceCache = new Map([
    [RUN006_HARNESS_PATH, harnessSource],
    ['scripts/patch83u-run006-contract-audit.mjs', auditSource],
  ]);
  let covered = 0;
  ...
  for (const row of traceability.requirements) {
    await resolveArtifactJsonPointer(
      ...
      row.schema_path,
      {
        pathCode: 'PATCH83U_RUN006_TRACEABILITY_SCHEMA_PATH_REFUSED',
        jsonCode: 'PATCH83U_RUN006_TRACEABILITY_SCHEMA_JSON_INVALID',
        pointerCode: 'PATCH83U_RUN006_TRACEABILITY_SCHEMA_POINTER_UNRESOLVED',
        cache: jsonCache,
      },
    );
    await resolveArtifactJsonPointer(
      ...
      row.evidence_field,
      {
        pathCode: 'PATCH83U_RUN006_TRACEABILITY_EVIDENCE_PATH_REFUSED',
        jsonCode: 'PATCH83U_RUN006_TRACEABILITY_EVIDENCE_JSON_INVALID',
        pointerCode: 'PATCH83U_RUN006_TRACEABILITY_EVIDENCE_POINTER_UNRESOLVED',
        cache: jsonCache,
      },
    );
    ...
    if (
      ...
      fail(
        'PATCH83U_RUN006_TRACEABILITY_ASSERTION_UNRESOLVED',
        row.requirement_id,
      );
    }
    ...
    const testReference = splitArtifactPointer(
      row.unit_test,
      'PATCH83U_RUN006_TRACEABILITY_TEST_REFERENCE_INVALID',
    );
    ...
    if (!testSource) {
      const testBytes = await readRepositoryArtifact(
        repositoryRoot,
        testReference.path,
        'PATCH83U_RUN006_TRACEABILITY_TEST_PATH_REFUSED',
      );
    ...
    if (
      ...
      fail('PATCH83U_RUN006_TRACEABILITY_TEST_UNRESOLVED', row.requirement_id);
    }
    ...
    if (
      ...
      fail(
        'PATCH83U_RUN006_TRACEABILITY_FAILURE_CODE_UNRESOLVED',
        row.requirement_id,
      );
    }
    covered += 1;
  }
  if (covered !== RUN006_REQUIRED_REQUIREMENT_IDS.length) {
    fail('PATCH83U_RUN006_STATIC_COVERAGE_INCOMPLETE');
  }
  const checkpointSchemaBytes = await readRepositoryArtifact(
    repositoryRoot,
    RUN006_CHECKPOINT_SCHEMA_PATH,
    'PATCH83U_RUN006_CHECKPOINT_SCHEMA_PATH_REFUSED',
  );
  let checkpointSchema;
  try {
    checkpointSchema = JSON.parse(checkpointSchemaBytes.toString('utf8'));
  } catch {
    fail('PATCH83U_RUN006_CHECKPOINT_SCHEMA_JSON_INVALID');
  }
...
export async function verifyRun006ContractArtifacts({
  freeze,
  repositoryRoot = process.cwd(),
} = {}) {
  objectValue(freeze, 'PATCH83U_RUN006_FREEZE_REQUIRED');
  const proofBinding = objectValue(
    freeze.proof_contract,
    'PATCH83U_RUN006_PROOF_BINDING_REQUIRED',
  );
  const traceabilityBinding = objectValue(
    freeze.traceability,
    'PATCH83U_RUN006_TRACEABILITY_BINDING_REQUIRED',
  );
  const checkpointSchemaBinding = objectValue(
    freeze.checkpoint_schema,
    'PATCH83U_RUN006_CHECKPOINT_SCHEMA_BINDING_REQUIRED',
  );
  const runContract = objectValue(
    freeze.run_contract,
    'PATCH83U_RUN006_RUN_CONTRACT_REQUIRED',
  );
  const [proofArtifact, traceabilityArtifact, markdownArtifact,
    ...
    await Promise.all([
      readBoundArtifact(
        repositoryRoot,
        RUN006_PROOF_CONTRACT_PATH,
        proofBinding.path,
        'PATCH83U_RUN006_PROOF_CONTRACT_PATH_REFUSED',
      ),
      readBoundArtifact(
        repositoryRoot,
        RUN006_TRACEABILITY_PATH,
        traceabilityBinding.json_path,
        'PATCH83U_RUN006_TRACEABILITY_PATH_REFUSED',
      ),
      readBoundArtifact(
        repositoryRoot,
        RUN006_TRACEABILITY_MARKDOWN_PATH,
        traceabilityBinding.markdown_path,
        'PATCH83U_RUN006_TRACEABILITY_MARKDOWN_PATH_REFUSED',
      ),
      readBoundArtifact(
        repositoryRoot,
        RUN006_CHECKPOINT_SCHEMA_PATH,
      ...
      readBoundArtifact(
        repositoryRoot,
        RUN006_EVIDENCE_SCHEMA_PATH,
        runContract.evidence_schema_path,
        'PATCH83U_RUN006_EVIDENCE_SCHEMA_PATH_REFUSED',
      ),
    ]);
  ...
  if (
    ...
    fail('PATCH83U_RUN006_PROOF_CONTRACT_HASH_MISMATCH');
  }
  if (
    ...
    fail('PATCH83U_RUN006_TRACEABILITY_HASH_MISMATCH');
  }
  if (
    ...
    fail('PATCH83U_RUN006_TRACEABILITY_MARKDOWN_HASH_MISMATCH');
  }
  if (
    ...
    fail('PATCH83U_RUN006_CHECKPOINT_SCHEMA_HASH_MISMATCH');
  }
  if (
    ...
    fail('PATCH83U_RUN006_EVIDENCE_SCHEMA_HASH_MISMATCH');
  }
  ...
  try {
    ...
    fail('PATCH83U_RUN006_PROOF_CONTRACT_JSON_INVALID');
  }
  try {
    traceability = JSON.parse(traceabilityArtifact.bytes.toString('utf8'));
  } catch {
    fail('PATCH83U_RUN006_TRACEABILITY_JSON_INVALID');
  }
  const proofValidation = validateRun006ProofContract(proofContract);
  const traceabilityValidation =
    validateRun006Traceability(traceability, proofContract);
  const staticCoverage = await auditRun006StaticCoverage({
    traceability,
    proofContract,
    repositoryRoot,
  });
  const markdown = markdownArtifact.bytes.toString('utf8');
  for (const requirementId of RUN006_REQUIRED_REQUIREMENT_IDS) {
    if (!markdown.includes(requirementId)) {
      fail('PATCH83U_RUN006_TRACEABILITY_MARKDOWN_INCOMPLETE', requirementId);
    }
  }
  if (
    proofBinding.schema_version !== RUN006_PROOF_CONTRACT_VERSION
    || proofBinding.contract_id !== RUN006_PROOF_CONTRACT_ID
    || proofBinding.requirement_count !== proofValidation.requirement_count
    || traceabilityBinding.schema_version !== RUN006_TRACEABILITY_VERSION
    ...
    || checkpointSchemaBinding.schema_version
      !== 'patch83u-staging-sql-editor-checkpoint-file-v2'
    || runContract.evidence_schema_version
      !== 'patch83u-staging-reset-proof-v5'
    || staticCoverage.static_coverage_count !== proofValidation.requirement_count
  ) {
    fail('PATCH83U_RUN006_CONTRACT_FREEZE_BINDING_INVALID');
  }
  ...
  if (
    ...
    fail('PATCH83U_RUN006_FINAL_SESSION_FREEZE_BINDING_MISMATCH');
  }
  ...
  if (
    ...
    fail('PATCH83U_RUN006_CONFIRMATION_FREEZE_BINDING_MISMATCH');
  }
  return Object.freeze({
    passed: true,
    requirement_count: proofValidation.requirement_count,
...
async function main() {
  ...
  const [proofContract, traceability] = await Promise.all([
    readFile(resolve(root, RUN006_PROOF_CONTRACT_PATH), 'utf8').then(JSON.parse),
    readFile(resolve(root, RUN006_TRACEABILITY_PATH), 'utf8').then(JSON.parse),
  ]);
  const result = validateRun006Traceability(traceability, proofContract);
  const staticCoverage = await auditRun006StaticCoverage({
    traceability,
    proofContract,
    repositoryRoot: root,
  ...
  process.stdout.write(
    `PATCH83U RUN006 CONTRACT TRACEABILITY PASSED `
...
if (process.argv[1] && resolve(process.argv[1]) === fileURLToPath(import.meta.url)) {
  main().catch((error) => {
    process.stderr.write(
      `${error instanceof Error ? error.message : 'PATCH83U_RUN006_CONTRACT_AUDIT_FAILED'}\n`,
    );
    process.exitCode = 1;
  });
}
