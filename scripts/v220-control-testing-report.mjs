...
const out = path.join(root, 'release/v220/v220-control-testing-report.md');
const report = `# v22.0 Control Testing + CAPA Execution Engine Report
...
console.log('v22.0 control testing report written.');
