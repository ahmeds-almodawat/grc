...
describe('Patch 83U authenticated surface release proof', () => {
  ...
  it('fails closed when future migration 235 introduces an unaudited SECURITY DEFINER routine', () => {
    const report = analyzePatch83uAuthSurface({
      migrationFiles: [{
        path: 'supabase/migrations/235_future_fixture.sql',
        text: `
  ...
  it('fails closed when future migration 235 makes a SECURITY DEFINER routine browser executable', () => {
    const report = analyzePatch83uAuthSurface({
      migrationFiles: [{
        path: 'supabase/migrations/235_browser_fixture.sql',
        text: `
  ...
  it('proves the target repository leaves no direct RPC exception and credential-locks global search through RLS', () => {
    ...
    expect(report.summary.reviewed_patch83u_migration_ceiling).toBe(234);
    expect(report.summary.reviewed_restricted_security_definer_count).toBe(128);
    expect(report.acl_reachable_security_definer_rpcs.reviewed_restricted_security_definers)
      .toEqual(expect.arrayContaining([
        expect.objectContaining({
        ...
        expect.objectContaining({
          ...
          source: 'migration200_service_role_acl_review',
          disposition: 'service_role_only',
        }),
        expect.objectContaining({
          name: 'f1_require_exact_governance_authority',
        ...
        expect.objectContaining({
          name: 'link_ovr_governed_document_version',
          source: 'migration210_service_role_acl_review',
          disposition: 'service_role_only',
        }),
        expect.objectContaining({
          name: 'unlink_ovr_governed_document_version',
          source: 'migration210_service_role_acl_review',
          disposition: 'service_role_only',
        }),
        expect.objectContaining({
          name: 'f2_require_exact_governance_authority',
          source: 'migration211_service_role_acl_review',
          disposition: 'owner_only',
        }),
        expect.objectContaining({
          name: 'initiate_ovr_governance_feedback_review',
          source: 'migration211_service_role_acl_review',
          disposition: 'service_role_only',
        }),
        expect.objectContaining({
          name: 'complete_ovr_governance_feedback_review',
          source: 'migration211_service_role_acl_review',
          disposition: 'service_role_only',
        }),
        expect.objectContaining({
          name: 'sync_ovr_corrective_action_capa_link',
          source: 'migration211_service_role_acl_review',
          disposition: 'service_role_only',
        }),
        expect.objectContaining({
          name: 'get_f2_ovr_governance_feedback_capabilities',
          source: 'migration211_service_role_acl_review',
          disposition: 'service_role_only',
        }),
        expect.objectContaining({
        ...
        expect.objectContaining({
          ...
          source: 'migration207_service_role_acl_review',
          disposition: 'service_role_only',
        }),
        expect.objectContaining({
        ...
        expect.objectContaining({
          name: 'dashboard_recent_governed_activity_v1',
          source: 'migration234_service_role_acl_review',
          disposition: 'service_role_only',
        }),
        ...[
        ...
        expect.objectContaining({
          name: 'f1r2_guard_evidence_parent_change',
          source: 'migration196_service_role_acl_review',
          disposition: 'owner_only',
        }),
        expect.objectContaining({
          name: 'f1r2_relink_evidence_parent',
          source: 'migration196_service_role_acl_review',
          disposition: 'service_role_only',
        }),
      ]));
