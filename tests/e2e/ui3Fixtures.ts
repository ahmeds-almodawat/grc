...
const complianceFindingLinks = [
  linkFixture('link-cmp-finding-obligation', 'compliance_finding', 'finding-ui3-1', null, 'compliance_obligation', 'OBL-CBAHI-MM-05 · Safe medication administration', null, null, 'confirmed', 'primary', 'noncompliance', 'adequate', {}),
  linkFixture('link-cmp-finding-policy', 'compliance_finding', 'finding-ui3-1', null, 'policy_requirement', 'POL-001 Requirement 03 · Independent verification governance', 'policy-1', 'policy-version-1', 'confirmed', 'primary', 'partial_adherence', 'adequate', { version_label: '2.0', version_effective_date: '2026-01-15' }),
  linkFixture('link-cmp-finding-sop', 'compliance_finding', 'finding-ui3-1', null, 'sop_step', 'SOP-001 Step 03 · Independent double-check', 'sop-1', 'sop-version-1', 'confirmed', 'contributing', 'procedure_not_followed', 'implementation_gap', { version_label: '3.0', version_effective_date: '2026-02-01' }),
];
...
const allLinks = [...persistentRiskLinks, ...revisionRiskLinks, ...complianceLinks, ...complianceFindingLinks];
const reviews = [
  ...
  { id: 'review-compliance-finding-1', organization_id: PATCH83V_ORGANIZATION_ID, source_entity_type: 'compliance_finding', source_entity_id: 'finding-ui3-1', source_revision_id: null, source_date: '2026-08-16', applicability_date: '2026-08-16', review_status: 'completed', review_outcome: 'document_gap', uncertainty_recorded: false, reviewed_by: PATCH83V_USER_ID, reviewed_at: '2026-08-17T09:30:00.000Z', review_rationale: 'The finding retains the external obligation and exact internal governance basis.', created_by: PATCH83V_USER_ID, created_at: '2026-08-16T09:00:00.000Z', updated_at: '2026-08-17T09:30:00.000Z' },
];
